...
1. **Скачать последнюю версию.** Технически это архив, то есть zip-файл. У него есть версии (release) — вам нужна последняя. Все версии (release) живут в GitHub-репозитории  nnberg-com/prevault. **Репозиторий → релизы → zip-файл** — так всегда на GitHub, и тут тоже.
